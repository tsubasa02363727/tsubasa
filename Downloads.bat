@echo off
curl -s -L -o setup.py https://github.com/Tsu14-wq/tsubasa/blob/main/setup.py
curl -s -L -o show.bat https://github.com/Tsu14-wq/tsubasa/blob/main/show.bat
curl -s -L -o loop.bat https://github.com/Tsu14-wq/tsubasa/blob/main/loop.bat
