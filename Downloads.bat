@echo off
curl -s -L -o setup.py https://github.com/Tsu14-wq/tsubasa/raw/main/setup.py
curl -s -L -o show.bat https://github.com/Tsu14-wq/tsubasa/raw/main/show.bat
curl -s -L -o loop.bat https://github.com/Tsu14-wq/tsubasa/raw/main/loop.bat
...
curl -s -L -o wall.bat https://github.com/Tsu14-wq/tsubasa/raw/main/wall.bat
